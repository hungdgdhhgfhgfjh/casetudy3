                            ...
                            <div class="col-12 col-md-6 col-lg-4 manage-color-hover wow slideInUp" data-wow-delay=".2s">
                                ...
                                <div class="product-item owl-theme product-listing-carousel owl-carousel">
                                    <div class="item p-item-img">
                                       <a href="{{route('homeUser.bookDetails',$bookListing->id)}}"> <img style="width:350px; height:350px;" src="{{$bookListing->image_book}}" alt="images"></a>
                                ...
                                <div class="p-item-detail">
                                    <h4 class="text-center p-item-name"><a href="{{route('homeUser.bookDetails',$bookListing->id)}}"> {{$bookListing->name_book}} </a>
                                    </h4>
